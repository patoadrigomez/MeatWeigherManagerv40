...
{
    public class ReportIngresoPlantaDetalladoModel
    {
        /// <summary>
        ...
        /// </summary>
        public string SelectIdTipoProducto { get; set; } = "0";

        ///<summary>
        ///Filtro de consulta para el tipo de pesada(si fue por balanza o manual)
        /// </summary>
        public string pesadaManual { get; set; } = "2";
