...
namespace FlexibleMessageBox
{
    ...
    */
    ...
    public static class FMB
    {
        ...
        {
            return FMBForm.Show(null, text, string.Empty, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1);
        }
        ...
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(string text,Font font)
        {
            DialogResult dlgResult;
            FONT = font;
            dlgResult= FMBForm.Show(null, text, string.Empty, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1);
        ...
        /// <param name="font">The Font.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(IWin32Window owner, string text,Font font)
        {
            DialogResult dlgResult;
            FONT = font;
            dlgResult= FMBForm.Show(owner, text, string.Empty, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1);
            FONT = SystemFonts.MessageBoxFont;
            return dlgResult;
        }
        /// <summary>
        ...
        {
            return FMBForm.Show(owner, text, string.Empty, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1);
        }
        ...
        {
            return FMBForm.Show(null, text, caption, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1);
        }
        ...
        /// <param name="font">The Font.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(string text, string caption,Font font)
        {
            DialogResult dlgResult;
            FONT = font;
            dlgResult = FMBForm.Show(null, text, caption, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1);
            FONT = SystemFonts.MessageBoxFont;
            return dlgResult;
        }
        ...
        {
            return FMBForm.Show(owner, text, caption, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1);
        }
        /// <summary>
        /// Shows the specified message box.
        /// </summary>
        ...
        /// <param name="font">The Font.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(IWin32Window owner, string text, string caption, Font font)
        {
            DialogResult dlgResult;
            FONT = font;
            dlgResult = FMBForm.Show(owner, text, caption, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1);
            FONT = SystemFonts.MessageBoxFont;
            return dlgResult;
        }
        ...
        {
            return FMBForm.Show(null, text, caption, buttons, MessageBoxIcon.None, MessageBoxDefaultButton.Button1);
        }
        ...
        /// <param name="font">The Font.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(string text, string caption, MessageBoxButtons buttons,Font font)
        {
            DialogResult dlgResult;
            FONT = font;
            dlgResult = FMBForm.Show(null, text, caption, buttons, MessageBoxIcon.None, MessageBoxDefaultButton.Button1);
            FONT = SystemFonts.MessageBoxFont;
            return dlgResult;
        }
        ...
        {
            return FMBForm.Show(owner, text, caption, buttons, MessageBoxIcon.None, MessageBoxDefaultButton.Button1);
        }
        ...
        /// <param name="font">The Font.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons,Font font)
        {
            DialogResult dlgResult;
            FONT = font;
            dlgResult = FMBForm.Show(owner, text, caption, buttons, MessageBoxIcon.None, MessageBoxDefaultButton.Button1);
            FONT = SystemFonts.MessageBoxFont;
            return dlgResult;
        }
        ...
        {
            return FMBForm.Show(null, text, caption, buttons, icon, MessageBoxDefaultButton.Button1);
        }
        ...
        public static DialogResult Show(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon,Font font)
        {
            DialogResult dlgResult;
            FONT = font;
            dlgResult = FMBForm.Show(null, text, caption, buttons, icon, MessageBoxDefaultButton.Button1);
            FONT = SystemFonts.MessageBoxFont;
            return dlgResult;
        }
        ...
        {
            return FMBForm.Show(owner, text, caption, buttons, icon, MessageBoxDefaultButton.Button1);
        }
        /// <summary>
        /// Shows the specified message box.
        /// </summary>
        ...
        /// <param name="font">The Font.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon,Font font)
        {
            DialogResult dlgResult;
            FONT = font;
            dlgResult = FMBForm.Show(owner, text, caption, buttons, icon, MessageBoxDefaultButton.Button1);
            FONT = SystemFonts.MessageBoxFont;
            return dlgResult;
        }
        ...
        {
            return FMBForm.Show(null, text, caption, buttons, icon, defaultButton);
        }
        ...
        /// <param name="font">The Font.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton,Font font)
        {
            DialogResult dlgResult;
            FONT = font;
            dlgResult = FMBForm.Show(null, text, caption, buttons, icon, defaultButton);
            FONT = SystemFonts.MessageBoxFont;
            return dlgResult;
        }
        ...
        {
            return FMBForm.Show(owner, text, caption, buttons, icon, defaultButton);
        }
        /// <summary>
        /// Shows the specified message box.
        /// </summary>
        ...
        /// <param name="font">The Font.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton,Font font)
        {
            DialogResult dlgResult;
            FONT = font;
            dlgResult = FMBForm.Show(owner, text, caption, buttons, icon, defaultButton);
            FONT = SystemFonts.MessageBoxFont;
            return dlgResult;
        }
        ...
        class FMBForm : Form
        {
            ...
            private void InitializeComponent()
            {
                ...
                this.richTextBoxMessage.Location = new System.Drawing.Point(50, 10);
                ...
                this.richTextBoxMessage.Size = new System.Drawing.Size(210, 50);
                ...
                this.panel1.Size = new System.Drawing.Size(276, 59);
                ...
                this.pictureBoxForIcon.BackgroundImageLayout = ImageLayout.Stretch;
                // 
                // button2
                // 
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="FMBForm"/> class.
            /// </summary>
            private FMBForm()
            {
                InitializeComponent();
            ...
            private static int GetCountStringRows(FMBForm flexibleMessageBoxForm,string message)
            {
                int rows = 0;
                if (string.IsNullOrEmpty(message)) return 0;
                rows = (TextRenderer.MeasureText(message, FONT).Width / (Screen.PrimaryScreen.Bounds.Width/2));
                return rows;
            }
            ...
            /// <param name="owner">The owner.</param>
            private static void SetDialogStartPosition(FMBForm flexibleMessageBoxForm, IWin32Window owner)
            {
            ...
            private static void SetDialogSizes(FMBForm flexibleMessageBoxForm, string text, string caption)
            {
                
                //First set the bounds for the maximum dialog size
                flexibleMessageBoxForm.MaximumSize = new Size(Convert.ToInt32(SystemInformation.WorkingArea.Width * FMBForm.GetCorrectedWorkingAreaFactor(MAX_WIDTH_FACTOR)),
                                                              Convert.ToInt32(SystemInformation.WorkingArea.Height * FMBForm.GetCorrectedWorkingAreaFactor(MAX_HEIGHT_FACTOR)));
                
                //Get rows. Exit if there are no rows to render...
                int stringRows = GetCountStringRows(flexibleMessageBoxForm,text);
                if (stringRows == 0) return;

                //Calculate whole text height
                var textHeight = TextRenderer.MeasureText(text, FONT).Height * stringRows;

                //Calculate width for longest text line

                var longestTextRowWidth = (TextRenderer.MeasureText(text, FONT).Width / stringRows);
                
                var captionWidth = TextRenderer.MeasureText(caption, SystemFonts.CaptionFont).Width;
                var textWidth = Math.Max(longestTextRowWidth, captionWidth);

                //Calculate margins
                var marginWidth = Screen.PrimaryScreen.Bounds.Width/2 - flexibleMessageBoxForm.richTextBoxMessage.Width;
                var marginHeight = Screen.PrimaryScreen.Bounds.Height/2 - flexibleMessageBoxForm.richTextBoxMessage.Height;
            ...
            private static void SetDialogIcon(FMBForm flexibleMessageBoxForm, MessageBoxIcon icon)
            {
                switch (icon)
                {
                    case MessageBoxIcon.Information:
                        flexibleMessageBoxForm.pictureBoxForIcon.BackgroundImage = SystemIcons.Information.ToBitmap();
                        break;
                    case MessageBoxIcon.Warning:
                        flexibleMessageBoxForm.pictureBoxForIcon.BackgroundImage = SystemIcons.Warning.ToBitmap();
                        break;
                    case MessageBoxIcon.Error:
                        flexibleMessageBoxForm.pictureBoxForIcon.BackgroundImage = SystemIcons.Error.ToBitmap();
                        break;
                    case MessageBoxIcon.Question:
                        flexibleMessageBoxForm.pictureBoxForIcon.BackgroundImage = SystemIcons.Question.ToBitmap();
                        break;
                    default:
                        //When no icon is used: Correct placement and width of rich text box.
            ...
            /// <param name="buttons">The buttons.</param>
            /// <param name="defaultButton">The default button.</param>
            private static void SetDialogButtons(FMBForm flexibleMessageBoxForm, MessageBoxButtons buttons, MessageBoxDefaultButton defaultButton)
            {
            ...
            public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton)
            {
                ...
                var flexibleMessageBoxForm = new FMBForm();
